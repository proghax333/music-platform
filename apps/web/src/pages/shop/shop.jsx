...
function ProductCard({ product }) {
  ...
  return (
    <NavLink to={`/shop/${product.id}`}><div
      className='flex-row  border-r-2 border-b-2 w-80 mx-4 mb-4 overflow-hidden'
    >
      ...
      <p className='text-sm ml-6 text-center mt-6  text-black font-bold' >{product.name}</p>
      <p className='text-lg text-black text-center ml-6'>{product.description}</p>
      ...
      <p className='text-xl font-[400] mr-4 text-end mb-5'><span className='text-base font-bold align-text-top'>₹</span>{product.price}</p>
